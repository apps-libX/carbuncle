...
use Mockery as m;
use Einherjars\Carbuncle\Users\Eloquent\Provider;
...
class EloquentUserProviderTest extends PHPUnit_Framework_TestCase {
	...
	{
		$provider = m::mock('Einherjars\Carbuncle\Users\Eloquent\Provider[createModel]', array($hasher = m::mock('Einherjars\Carbuncle\Hashing\HasherInterface')));

		$user = m::mock('Einherjars\Carbuncle\Users\Eloquent\User');
	...
	{
		$provider = m::mock('Einherjars\Carbuncle\Users\Eloquent\Provider[createModel]', array(m::mock('Einherjars\Carbuncle\Hashing\HasherInterface')));
	...
	public function testFindingByCredentialsFailsWhenModelIsNull()
	{
		...
		$provider = m::mock('Einherjars\Carbuncle\Users\Eloquent\Provider[createModel,getHashableCredentials]', array(m::mock('Einherjars\Carbuncle\Hashing\HasherInterface')));
		$provider->shouldReceive('createModel')->once()->andReturn($user);
	...
	/**
	 * Regression test for https://github.com/einherjars/carbuncle/issues/148
	 *
	 * @expectedException Einherjars\Carbuncle\Users\WrongPasswordException
	 */
	public function testFindingByCredentialsFailsForBadPassword()
	{
		$actualUser = m::mock('Einherjars\Carbuncle\Users\Eloquent\User');
		...
		$hasher = m::mock('Einherjars\Carbuncle\Hashing\HasherInterface');
		...
		$provider = m::mock('Einherjars\Carbuncle\Users\Eloquent\Provider[createModel,getHashableCredentials]', array($hasher));
	...
	/**
	 * Regression test for https://github.com/einherjars/carbuncle/issues/157
	 *
	 * @expectedException InvalidArgumentException
	 */
	public function testFindByNullActivationCode()
	{
		$provider = new Provider($hasher = m::mock('Einherjars\Carbuncle\Hashing\HasherInterface'));
	...
	public function testFindingAllUsers()
	{
		...
		$provider->shouldReceive('createModel')->once()->andReturn($user = m::mock('Einherjars\Carbuncle\Users\Eloquent\User'));
		...
		$collection->shouldReceive('all')->once()->andReturn(array($user = m::mock('Einherjars\Carbuncle\Users\User')));
	...
	{
		$provider = m::mock('Einherjars\Carbuncle\Users\Eloquent\Provider[findAll]', array(m::mock('Einherjars\Carbuncle\Hashing\HasherInterface')));
