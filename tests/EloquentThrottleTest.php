...
use Mockery as m;
use Einherjars\Carbuncle\Throttling\Eloquent\Throttle;
use DateTime;
...
class EloquentThrottleTest extends PHPUnit_Framework_TestCase {
	...
	public function testGettingUserReturnsUserObject()
	{
		...
		$throttle = m::mock('Einherjars\Carbuncle\Throttling\Eloquent\Throttle[user]');
	...
	{
		$throttle = m::mock('Einherjars\Carbuncle\Throttling\Eloquent\Throttle[clearLoginAttemptsIfAllowed]');
	...
	{
		$throttle = m::mock('Einherjars\Carbuncle\Throttling\Eloquent\Throttle[save]');
	...
	public function testSuspend()
	{
		...
		$throttle = m::mock('Einherjars\Carbuncle\Throttling\Eloquent\Throttle[save,getConnection]');;
	...
	// {
	// 	$throttle = m::mock('Einherjars\Carbuncle\Throttling\Eloquent\Throttle[suspend,save]');
	// 	$throttle->shouldReceive('save')->once();
	...
	// 	$throttle = m::mock('Einherjars\Carbuncle\Throttling\Eloquent\Throttle[isBanned,isSuspended,getUser]');
	...
	// {
	// 	$throttle = m::mock('Einherjars\Carbuncle\Throttling\Eloquent\Throttle[isBanned,isSuspended]');
	// 	$throttle->shouldReceive('isBanned')->once()->andReturn(false);
