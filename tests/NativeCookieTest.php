...
class NativeCookieTest extends PHPUnit_Framework_TestCase {
	...
	{
		$cookie = m::mock('Einherjars\Carbuncle\Cookies\NativeCookie[minutesToLifetime,setCookie]');
	...
	{
		$cookie = m::mock('Einherjars\Carbuncle\Cookies\NativeCookie[put]');
	...
	{
		$cookie = m::mock('Einherjars\Carbuncle\Cookies\NativeCookie[getCookie]');
