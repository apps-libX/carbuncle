...
use Mockery as m;
use Einherjars\Carbuncle\Users\Eloquent\User;
...
class EloquentUserTest extends PHPUnit_Framework_TestCase {
	...
	{
		$user = m::mock('Einherjars\Carbuncle\Users\Eloquent\User[getKey]');
	...
	{
		$user = m::mock('Einherjars\Carbuncle\Users\Eloquent\User[getLoginName]');
	...
	{
		User::setHasher($hasher = m::mock('Einherjars\Carbuncle\Hashing\HasherInterface'));
	...
	public function testGettingGroups()
	{
		...
		$user  = m::mock('Einherjars\Carbuncle\Users\Eloquent\User[groups]');
	...
	{
		$group1 = m::mock('Einherjars\Carbuncle\Groups\GroupInterface');
		$group1->shouldReceive('getId')->once()->andReturn(123);

		$group2 = m::mock('Einherjars\Carbuncle\Groups\GroupInterface');
		$group2->shouldReceive('getId')->once()->andReturn(124);

		$user = m::mock('Einherjars\Carbuncle\Users\Eloquent\User[getGroups]');
	...
	public function testAddingToGroupChecksIfAlreadyInThatGroup()
	{
		...
		$user  = m::mock('Einherjars\Carbuncle\Users\Eloquent\User[inGroup,groups]');
	...
	public function testAddingGroupAttachesToRelationship()
	{
		...
		$user  = m::mock('Einherjars\Carbuncle\Users\Eloquent\User[inGroup,groups,invalidateMergedPermissionsCache,invalidateUserGroupsCache]');
	...
	public function testMergedPermissions()
	{
		...
		$user = m::mock('Einherjars\Carbuncle\Users\Eloquent\User[getGroups,getPermissions]');
	...
	{
		$user  = m::mock('Einherjars\Carbuncle\Users\Eloquent\User[isSuperUser]');
	...
	{
		$user = m::mock('Einherjars\Carbuncle\Users\Eloquent\User[isSuperUser,getMergedPermissions]');
	...
	/**
	 * Feature test for https://github.com/einherjars/carbuncle/issues/123
	 */
	...
	/**
	 * Feature test for https://github.com/einherjars/carbuncle/pull/131
	 */
	...
	{
		$user = m::mock('Einherjars\Carbuncle\Users\Eloquent\User[hasAccess]');
	...
	/**
	 * @expectedException Einherjars\Carbuncle\Users\UserExistsException
	 */
	public function testValidationFailsWhenUserAlreadyExists()
	{
		...
		$persistedUser = m::mock('Einherjars\Carbuncle\Users\UserInterface');
		$persistedUser->shouldReceive('getId')->once()->andReturn(123);

		$user = m::mock('Einherjars\Carbuncle\Users\Eloquent\User[newQuery]');
		$user->email = 'foo@bar.com';
	...
	{
		$user = m::mock('Einherjars\Carbuncle\Users\Eloquent\User[save]');
	...
	public function testGetPersistCode()
	{
		...
		$user = m::mock('Einherjars\Carbuncle\Users\Eloquent\User[save,getRandomString]');
	...
	/**
	 * @expectedException Einherjars\Carbuncle\Users\UserAlreadyActivatedException
	 */
	public function testUserIsNotActivatedTwice()
	{
		$user = m::mock('Einherjars\Carbuncle\Users\Eloquent\User[checkHash]');
	...
	{
		$user = m::mock('Einherjars\Carbuncle\Users\Eloquent\User[getActivationCode,checkHash,save]');
	...
	{
		$user = m::mock('Einherjars\Carbuncle\Users\Eloquent\User[getPassword,checkHash]');
	...
	{
		User::setHasher($hasher = m::mock('Einherjars\Carbuncle\Hashing\HasherInterface'));
		$user = m::mock('Einherjars\Carbuncle\Users\Eloquent\User[checkResetPasswordCode,save]');
