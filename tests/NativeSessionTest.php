...
class NativeSessionTest extends PHPUnit_Framework_TestCase {
	...
	{
		$session = $this->getMock('Einherjars\Carbuncle\Sessions\NativeSession', array('startSession'));
	}

	public function testOverridingKey()
	{
		$session = $this->getMock('Einherjars\Carbuncle\Sessions\NativeSession', array('startSession'), array('foo'));
	...
	{
		$session = $this->getMock('Einherjars\Carbuncle\Sessions\NativeSession', array('startSession', 'getSession'));
