...
use Mockery as m;
use Einherjars\Carbuncle\Groups\Eloquent\Provider;
use GroupModelStub1;
use GroupModelStub2;
...
class EloquentGroupProviderTest extends PHPUnit_Framework_TestCase {
	...
	{
		$provider = m::mock('Einherjars\Carbuncle\Groups\Eloquent\Provider[createModel]');
	...
	/**
	 * @expectedException Einherjars\Carbuncle\Groups\GroupNotFoundException
	 */
	...
	public function testFindingAll()
	{
		...
		$group1 = m::mock('Einherjars\Carbuncle\Groups\Eloquent\Group')->shouldReceive('hasGetMutator')->andReturn(false);
		$group2 = m::mock('Einherjars\Carbuncle\Groups\Eloquent\Group')->shouldReceive('hasGetMutator')->andReturn(false);
	...
	public function testCreatingGroup()
	{
		...
		$group = m::mock('Einherjars\Carbuncle\Groups\EloquentGroup');
