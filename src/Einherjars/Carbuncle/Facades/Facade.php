<?php namespace Einherjars\Carbuncle\Facades;
/**
...
abstract class Facade {
	 ...
	 * Carbuncle instance.
	 *
	 * @var \Einherjars\Carbuncle\Carbuncle
	 */
	protected static $instance;

	/**
	 * Returns the Carbuncle instance registered with the Facade.
	 *
	...
	public static function instance()
	{
		if (static::$instance === null)
		{
			static::$instance = forward_static_call_array(
				array(get_called_class(), 'createCarbuncle'),
				func_get_args()
			);
		}
