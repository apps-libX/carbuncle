...
class Group extends Model implements GroupInterface {
	 ...
	 * @var string
	 */
	protected static $userModel = 'Einherjars\Carbuncle\Users\Eloquent\User';
	 ...
	 *
	 * @return bool
	 * @throws \Einherjars\Carbuncle\Groups\NameRequiredException
	 * @throws \Einherjars\Carbuncle\Groups\GroupExistsException
	 */
